...
class DataDrawer():
    ...
    def newDataFrame(self, frameNo, mode, date, lat, lon, altitude, speed, track, climb, tempC):
        ...
        if frameNo > self.lastFrameNo:
            ...
            #data
            drawBoxedText(frameDraw,10,480,230,20,"Time      " + date[:16],self.font,TEXTCOLOUR,BOXCOLOUR)
            drawBoxedText(frameDraw,10,510,230,20,"Temp      " + str(round(tempC,1)) + " C",self.font,TEXTCOLOUR,BOXCOLOUR)
            drawBoxedText(frameDraw,10,540,230,20,"Speed     " + str(round(speed * GpsUtils.MPS_TO_MPH,1)) + " mph",self.font,TEXTCOLOUR,BOXCOLOUR)
            drawBoxedText(frameDraw,10,570,230,20,"Altitude  " + str(round(altitude,1)) + " m",self.font,TEXTCOLOUR,BOXCOLOUR)
            #drawBoxedText(frameDraw,10,420,230,20,"Climb     " + str(round(climb,1)),self.font,TEXTCOLOUR,BOXCOLOUR)
            #drawBoxedText(frameDraw,10,450,230,20,"Track     " + str(round(track,1)),self.font,TEXTCOLOUR,BOXCOLOUR)
            #drawBoxedText(frameDraw,10,480,230,20,"Latitude  " + str(lat),self.font,TEXTCOLOUR,BOXCOLOUR)
            #drawBoxedText(frameDraw,10,510,230,20,"Longitude " + str(lon),self.font,TEXTCOLOUR,BOXCOLOUR)
